...
$error = new Errors;
$incidents->id=isset($data->id)? $data->id : die($error->missen('Id missen from request'));
$incidents->status=isset($data->status)? $data->status : die($error->missen('status missen from request'));
...
echo json_encode($incidents->updateIncident());
